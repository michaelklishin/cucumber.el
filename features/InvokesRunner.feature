Feature: Invokes Runner
  ...
  Scenario: Uses rake when Rakefile present
    ...
    And an empty file "test.feature"
    When I run `emacs --batch -l ../../feature-mode.el test.feature --eval '(progn (feature-mode) (feature-verify-all-scenarios-in-buffer) (set-buffer "*compilation*") (princ (buffer-string)))'`
